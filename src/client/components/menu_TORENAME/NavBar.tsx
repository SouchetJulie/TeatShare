...
import GradeLinks from "@components/menu_TORENAME/GradeLinks";
import UserLinks from "@components/menu_TORENAME/UserLinks";
import { selectAuthenticatedUser } from "@stores/user.store";
import styles from "@styles/menu/navbar.module.scss";
import { NavbarVariant } from "@typing/navbar-variant.enum";
import LessonLinks from "@components/menu_TORENAME/LessonLinks";
